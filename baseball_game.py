...
def is_between_100_and_999(user_input_number):
    ...
    result = True if 100<=num<=999 else False
...
def is_validated_number(user_input_number):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    # print(is_duplicated_number(user_input_number),len(set(user_input_number)))
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    for i in range(3):
        if user_input_number[i] == random_number[i]:
            strikes.append(user_input_number[i])
    for i in range(3):
        if user_input_number[i] in random_number and user_input_number[i] not in strikes:
            balls.append(user_input_number[i])
    result = [len(strikes), len(balls)]
    # ==================================
    return result


def is_yes(one_more_input: str):
    # '''
    # Input:
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    upperinput = one_more_input.upper()
    result = True if upperinput == 'Y' or upperinput == 'YES' else False
    # ==================================
    return result
...
def is_no(one_more_input):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    upperinput = one_more_input.upper()
    result = True if upperinput == 'N' or upperinput == 'NO' else False
    # ==================================
    return result
